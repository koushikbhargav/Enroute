<template>
  <div id="wrapper">
    <div class="container page">
      ...
      <div class="btns">
        <button  @click.prevent="sendLendRequest" class="button green full-width button-sliding-icon ripple-effect margin-top-10"  form="login-form">Request Funds<i class="icon-material-outline-arrow-right-alt"></i></button>
      </div>
    </div>
  </div>
</template>
