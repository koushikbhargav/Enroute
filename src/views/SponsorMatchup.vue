<template>
  <div id="wrapper">
    <div class="container page">
      ...
      <h2 class="page-subheader">Pick any to proceed to interview</h2>
          ...
          <div class="freelancers-container freelancers-grid-layout margin-top-35">
            ...
            <div class="freelancer" id="second" v-on:click="select($event)">
              ...
              <div class="freelancer-details">
                <div class="freelancer-details-list" >
                  <ul>
                    <li>Location <strong><i class="icon-material-outline-location-on"></i>Nepal</strong></li>
            ...
            <div class="freelancer" id="third" v-on:click="select($event)">
              ...
              <div class="freelancer-details">
                <div class="freelancer-details-list">
                  <ul>
                    <li>Location <strong><i class="icon-material-outline-location-on"></i> Sri Lanka</strong></li>
                    <li>Rate <strong>Rs25000 / month</strong></li>
